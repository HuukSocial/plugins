...
abstract class TestHostVideoPlayerApi {
  ...
  static void setup(TestHostVideoPlayerApi? api, {BinaryMessenger? binaryMessenger}) {
    ...
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.VideoPlayerApi.preload', codec, binaryMessenger: binaryMessenger);
      if (api == null) {
        channel.setMockMessageHandler(null);
      } else {
        channel.setMockMessageHandler((Object? message) async {
          assert(message != null, 'Argument for dev.flutter.pigeon.VideoPlayerApi.preload was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final PreloadMessage? arg_msg = (args[0] as PreloadMessage?);
          assert(arg_msg != null, 'Argument for dev.flutter.pigeon.VideoPlayerApi.preload was null, expected non-null PreloadMessage.');
          api.preload(arg_msg!);
          return <Object?, Object?>{};
        });
      }
