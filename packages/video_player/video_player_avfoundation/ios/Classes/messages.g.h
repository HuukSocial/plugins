...
@property(nonatomic, strong) NSDictionary<NSString *, NSNumber *> * resolutionConfig;
@end
...
/// @return `nil` only when `error != nil`.
- (void)predownloadAndCache:(FLTPreloadMessage *)msg error:(FlutterError *_Nullable *_Nonnull)error;
@end
