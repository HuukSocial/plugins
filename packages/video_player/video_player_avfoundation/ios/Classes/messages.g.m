...
- (NSDictionary *)toMap {
  return [NSDictionary dictionaryWithObjectsAndKeys:(self.urls ? self.urls : [NSNull null]), @"urls", (self.shouldPreloadFirstSegment ? self.shouldPreloadFirstSegment : [NSNull null]), @"shouldPreloadFirstSegment", (self.headers ? self.headers : [NSNull null]), @"headers", nil];
}
@end
