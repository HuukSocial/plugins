...
class _TestHostVideoPlayerApiCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    if (value is CreateMessage) {
      ...
      buffer.putUint8(132);
      writeValue(buffer, value.encode());
    } else if (value is PreloadMessage) {
      buffer.putUint8(133);
      writeValue(buffer, value.encode());
...
abstract class TestHostVideoPlayerApi {
  ...
  static void setup(TestHostVideoPlayerApi? api,
    ...
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.VideoPlayerApi.preload', codec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        channel.setMockMessageHandler(null);
      } else {
        channel.setMockMessageHandler((Object? message) async {
          assert(message != null,
              'Argument for dev.flutter.pigeon.VideoPlayerApi.preload was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final PreloadMessage? arg_msg = (args[0] as PreloadMessage?);
          assert(arg_msg != null,
              'Argument for dev.flutter.pigeon.VideoPlayerApi.preload was null, expected non-null PreloadMessage.');
          api.preload(arg_msg!);
          return <Object?, Object?>{};
        });
      }
